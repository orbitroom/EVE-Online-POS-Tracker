<?php
/* $Id: eveclass.php 238 2012-03-26 05:40:38Z frozenice2525 $ */
...
define('GOOD_IGB', 'EVE-minibrowser'); // Correct IGB User_Agent (*when fixed*)
define('GOOD_IGB2', 'EVE-IGB'); // Dominion IGB
...
class Eve {
    ...
    */
    function IsMiniBrowser($_BypassCheck = False, $_BogusHeaderCheck = False) {
        ...
        if($_BypassCheck) {
            ...
            //if (($parts[0] == GOOD_IGB) or ($parts[0] == GOOD_IGB2) or ($parts[0] == BROKE_IGB)) {
            if (preg_match('/'.GOOD_IGB2.'/i', $this->BrowserAgent()) || preg_match('/'.GOOD_IGB.'/i', $this->BrowserAgent()) || preg_match('/'.BROKE_IGB.'/i', $this->BrowserAgent())) {
    ...
    */
    ...
    function VarPrepHTMLDisplay()
    {
        ...
        $stuff = array('a' => '2', 'br' => '2', 'strong' => '1', 'ul' => '1', 'li' => '1', 'i' => '1');
